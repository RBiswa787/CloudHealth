...
// import {FormControl, InputLabel, MenuItem, Paper, Select, Button, TextField, Typography} from "@mui/material";
...
const DoctorProfileCreation = () => {
    ...
    return <div style={{
        ...
        <Paper className={classes.paper} elevation={20} style={{width: "65%", height:"90%", borderRadius:30, backgroundColor: "#DFF6FF",}}>
            ...
            <Typography style={{marginTop:"2%", fontFamily: "Arvo, serif", fontSize: "36px",display: "flex"}}>Doctor Profile Creation</Typography>
            <TextField
                // error={lUserError}
                id="set-name"
