...
const DEdit = () => {
    ...
    useEffect(() => {
        let data = {"username": "test101"};
        axios.post("http://localhost:8787/api/doctor/get", data)
            .then(
                res => {
                    console.log("Hello")
                    console.log(res)
                    ...
                    setDisplayExperience(res.data.experience)
        ...
        <>
            ...
            <Grid className={classes.grid2} container justify="center">
                ...
                <Paper elevation={0} style={{fontSize: '15px', width: '30vw', lineHeight: '1.8'}}>
                    ...
                    <div>{displayQualification}</div>
                    <div>{displayExperience}</div>
            ...
            <Grid style={{display: "flex", flexDirection: "column", alignItems: "center", marginBottom: "10vh"}}
                  container>
            ...
            <Grid style={{padding: "2%"}} container justify="center">
                {tabIndex === 0 && (
                    <Box>
                        <form>
                            <label style={{marginRight: '10vw', fontWeight: 'bold'}} htmlFor='startTime'>Start
                                Time</label>
